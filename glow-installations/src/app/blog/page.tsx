  ...
  return (
    <div className="bg-[var(--night)] pb-24 text-white">
      ...
      <section className="section-full bg-[var(--deep-navy)]">
        <div className="container grid gap-5 md:grid-cols-3">
          {BLOG_POSTS.map((post) => (
            <article
              key={post.slug}
              className="rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm transition hover:border-[var(--gold)]/35 hover:bg-white/[0.08]"
            >
      ...
      <section className="section-full bg-[var(--night)]">
        <div className="container max-w-3xl rounded-2xl border border-white/10 bg-white/5 p-6">
